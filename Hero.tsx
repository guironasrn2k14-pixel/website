...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 bg-card-bg relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            <h2 className="text-sm font-bold tracking-widest text-accent uppercase mb-3">Contato</h2>
            <h3 className="text-4xl md:text-5xl font-bold mb-6">Vamos criar algo incrível juntos.</h3>
            <p className="text-gray-400 text-lg mb-12 max-w-md">
              Tem um projeto em mente ou apenas quer dizer olá? Fique à vontade para me enviar uma mensagem.
            </p>
            ...
            <div className="space-y-8 mb-12">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+5511954629657" className="text-gray-400 hover:text-accent transition-colors">
                    +55 (11) 95462-9657
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">São Paulo, SP - Brasil (Remoto)</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="https://www.instagram.com/guiroonas/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-main-bg border border-gray-800 flex items-center justify-center text-gray-400 hover:text-white hover:border-accent transition-all group">
